<template>
  <div class="wrap">
    ...
    <div class='margin12'>
      ...
      <div class='temp-wrap'>
        <div class='temp-img'>
          <img src='http://crayon.today/571677159247_.pic.jpg' alt='原神胡桃圣遗物示例图' />
        </div>
        <div class='temp-text'>
    ...
    <div class='margin12'>
      ...
      <div>
        <img class='wxapp-image' src='http://crayon.today/gh_a6861ef047ae_430.jpg' alt='老婆养成小助手' />
      </div>
      <div>
        <img class='wxapp-image' src='http://crayon.today/WechatIMG35.jpeg' alt='抖音殇离' />
      </div>
    </div>
