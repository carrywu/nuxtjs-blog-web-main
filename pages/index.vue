  ...
  <div>
    ...
    <div v-if="isLoad" class="response-wrap more" @click="loadMore">
      ...
      <div class="more-arrow">
        <img src="http://crayon.today/arrow.png" alt="" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  head() {
    return {
      title: '博客 - boblog.com - 技术博客',
      meta: [
        {
          name: 'keywords',
          content:
            '波波,博客,博客,梁凤波,bo,blog,boblog,前端开发工程师,前端性能优化,JavaScript,css,html',
        },
        {
          name: 'description',
          content: '博客 - BoBlog.com，专注于前端开发技术，前端性能优化！',
        },
      ],
    }
  },
